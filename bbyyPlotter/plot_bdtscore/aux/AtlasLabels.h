...
void ATLASLabel(Double_t x,Double_t y,const char* text=NULL, double size=0.04, double delx=0.08, Color_t color=1); 

void ATLASLabelWIP(Double_t x,Double_t y,const char* text=NULL, double size=0.04, double delx=0.08, double next_line=0.04, Color_t color=1);
