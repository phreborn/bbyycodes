...
void plotter_yybb_log(TString region = "SM", TString s_test="test", TString MVA ="BDT_cat"){
  ...
  TGraphAsymmErrors errCopy_TI = MakePoissonErrors(*h_TI, h_TI->Integral(), 1);
...
color6->SetRGB(253/255., 197/255., 54/255.);
  ...
  cout << hCopy_H->Integral() << endl;
  cout << hCopy_H->Integral(0.8 * n_bins, n_bins) << endl;
  ...
  hCopy_TI->GetYaxis()->SetRangeUser(0.001, 5 * find_max(hCopy_TI,hCopy_HH));
