...
void myBoxText(Double_t x, Double_t y,Double_t boxsize,Int_t mcolor,const char *text,Int_t lcolor,Int_t lstyle) 
{

  Double_t tsize=0.07;

  TLatex l; l.SetTextAlign(12); 
  l.SetTextSize(tsize*0.5); 
  l.SetNDC();
  l.DrawLatex(x-0.01,y,text);
  ...
  mline.DrawLineNDC(x1,y_new,x2,y_new);
  //mline.DrawLineNDC(x_new,y1,x_new,y2);
