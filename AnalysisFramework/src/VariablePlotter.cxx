  ...
  for (auto iSample : document.samples.samples) {
	...
	for (auto iCut : cutFlows) {
	  ...
	  */
	  ...
	  if (select.find("HGamEventInfoAuxDyn.isPassed") != std::string::npos) { select = select.std::string::replace(select.find("HGamEventInfoAuxDyn.isPassed"), std::string("HGamEventInfoAuxDyn.isPassed").length(), "HGamEventInfoAuxDyn.isPassed" + truthMatch);}

	  //if (select.find("HGamEventInfoAuxDyn.yybb_btag77_BCal_cutFlow") != std::string::npos) { select = select.std::string::replace(select.find("HGamEventInfoAuxDyn.yybb_btag77_BCal_cutFlow == 6"), std::string("HGamEventInfoAuxDyn.yybb_btag77_BCal_cutFlow == 6").length(), "HGamEventInfoAuxDyn.yybb_btag77_BCal_cutFlow == 6" + truthMatch);}
