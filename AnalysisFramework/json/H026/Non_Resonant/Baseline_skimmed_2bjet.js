{
  ...
  "variables": {
    ...
    "weight": {
      "var": "HGamEventInfoAuxDyn.crossSectionBRfilterEff*HGamEventInfoAuxDyn.weight*HGamEventInfoAuxDyn.yybb_weight",
      "bins": {
        "nbins": 200,
        "lbins": -10,
        "ubins": 10
  ...
  "selections": {
    ...
    "Pass_yy": "HGamEventInfoAuxDyn.isPassed == 1 && HGamEventInfoAuxDyn.passCrackVetoCleaning  == 1",
    "Validation": "HGamEventInfoAuxDyn.isPassed == 1 && HGamEventInfoAuxDyn.passCrackVetoCleaning  == 1 && HGamEventInfoAuxDyn.yybb_btag77_BCal_cutFlow == 6",
