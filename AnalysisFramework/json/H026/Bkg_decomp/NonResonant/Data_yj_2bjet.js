{
  ...
  "selections": 
  { 
    "Pass_yy"    : "HGamEventInfoAuxDyn.isPassedRelPtCuts == 1 && HGamEventInfoAuxDyn.isPassedMassCut == 1 && HGamPhotonsAuxDyn.isIsoFixedCutLoose[0] == 1 && HGamPhotonsAuxDyn.isIsoFixedCutLoose[1] == 1 && ( ( HGamPhotonsAuxDyn.isTight[0] ==1 && HGamPhotonsAuxDyn.isTight[1] == 0) || ( HGamPhotonsAuxDyn.isTight[0] ==0 && HGamPhotonsAuxDyn.isTight[1] == 1 ) )",
    "Validation" : "HGamEventInfoAuxDyn.isPassedRelPtCuts == 1 && HGamEventInfoAuxDyn.isPassedMassCut == 1 && HGamEventInfoAuxDyn.yybb_btag77_BCal_cutFlow == 6 && HGamPhotonsAuxDyn.isIsoFixedCutLoose[0] == 1 && HGamPhotonsAuxDyn.isIsoFixedCutLoose[1] == 1 && ( ( HGamPhotonsAuxDyn.isTight[0] ==1 && HGamPhotonsAuxDyn.isTight[1] == 0) || ( HGamPhotonsAuxDyn.isTight[0] ==0 && HGamPhotonsAuxDyn.isTight[1] == 1 ) )",
    "Validation_2bjet"    : "(HGamEventInfoAuxDyn.isPassedRelPtCuts == 1 && HGamEventInfoAuxDyn.isPassedMassCut == 1 && HGamEventInfoAuxDyn.yybb_btag77_BCal_cutFlow == 6 && HGamPhotonsAuxDyn.isIsoFixedCutLoose[0] == 1 && HGamPhotonsAuxDyn.isIsoFixedCutLoose[1] == 1 && ( ( HGamPhotonsAuxDyn.isTight[0] ==1 && HGamPhotonsAuxDyn.isTight[1] == 0) || ( HGamPhotonsAuxDyn.isTight[0] ==0 && HGamPhotonsAuxDyn.isTight[1] == 1 ) ) && HGamAntiKt4PFlowCustomVtxHggJetsAuxDyn.DL1r_FixedCutBEff_77[HGamEventInfoAuxDyn.yybb_candidate_jet1_fix] && HGamAntiKt4PFlowCustomVtxHggJetsAuxDyn.DL1r_FixedCutBEff_77[HGamEventInfoAuxDyn.yybb_candidate_jet2_fix] )",
