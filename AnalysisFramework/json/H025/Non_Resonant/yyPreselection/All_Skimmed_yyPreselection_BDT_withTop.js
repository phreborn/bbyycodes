  ...
  "sequencer":["VariablePlotter"],
   ...
   "dumper":{
    ...
    "selections": {
      ...
      "XGBoost_btag77_85_withTop_BReg_tightScore_HMass" : "(HGamEventInfoAuxDyn.isPassed == 1 && (((HGamEventInfoAuxDyn.yybb_nonRes_XGBoost_btag77_85_BReg_Cat/1000) % 10) == 1) )",
      "XGBoost_btag77_85_withTop_BReg_looseScore_HMass" : "(HGamEventInfoAuxDyn.isPassed == 1 && (((HGamEventInfoAuxDyn.yybb_nonRes_XGBoost_btag77_85_BReg_Cat/1000) % 10) == 2) )",
      "XGBoost_btag77_85_withTop_BReg_tightScore_LMass" : "(HGamEventInfoAuxDyn.isPassed == 1 && (((HGamEventInfoAuxDyn.yybb_nonRes_XGBoost_btag77_85_BReg_Cat/1000) % 10) == 3) )",
      "XGBoost_btag77_85_withTop_BReg_looseScore_LMass" : "(HGamEventInfoAuxDyn.isPassed == 1 && (((HGamEventInfoAuxDyn.yybb_nonRes_XGBoost_btag77_85_BReg_Cat/1000) % 10) == 4) )",
      
      "XGBoost_btag77_withTop_BReg_tightScore_HMass"    : "(HGamEventInfoAuxDyn.isPassed == 1 && (((HGamEventInfoAuxDyn.yybb_nonRes_XGBoost_btag77_BReg_Cat/1000) % 10) == 1)    )",
      "XGBoost_btag77_withTop_BReg_looseScore_HMass"    : "(HGamEventInfoAuxDyn.isPassed == 1 && (((HGamEventInfoAuxDyn.yybb_nonRes_XGBoost_btag77_BReg_Cat/1000) % 10) == 2)    )",
      "XGBoost_btag77_withTop_BReg_tightScore_LMass"    : "(HGamEventInfoAuxDyn.isPassed == 1 && (((HGamEventInfoAuxDyn.yybb_nonRes_XGBoost_btag77_BReg_Cat/1000) % 10) == 3)    )",
      "XGBoost_btag77_withTop_BReg_looseScore_LMass"    : "(HGamEventInfoAuxDyn.isPassed == 1 && (((HGamEventInfoAuxDyn.yybb_nonRes_XGBoost_btag77_BReg_Cat/1000) % 10) == 4)    )",
      ...
      "XGBoost_btag77_85_withTop_KF_looseScore_LMass"   : "(HGamEventInfoAuxDyn.isPassed == 1 && (((HGamEventInfoAuxDyn.yybb_nonRes_XGBoost_btag77_85_KF_Cat/0) % 10) == 4)      )",
