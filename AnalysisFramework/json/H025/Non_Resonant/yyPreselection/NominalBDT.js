  ...
  "sequencer":["VariablePlotter"],
   ...
   "dumper":{
    ...
    "selections": {
      ...
      "XGBoost_btag77_Nominal_tightScore_HMass" : "(HGamEventInfoAuxDyn.isPassed == 1 &&  HGamEventInfoAuxDyn.yybb_btag77_vbf_selected== 0 && ((HGamEventInfoAuxDyn.yybb_nonRes_XGBoost_btag77_Cat % 10) == 1) )",
      "XGBoost_btag77_Nominal_looseScore_HMass" : "(HGamEventInfoAuxDyn.isPassed == 1 &&  HGamEventInfoAuxDyn.yybb_btag77_vbf_selected== 0 && ((HGamEventInfoAuxDyn.yybb_nonRes_XGBoost_btag77_Cat % 10) == 2) )",
      "XGBoost_btag77_Nominal_tightScore_LMass" : "(HGamEventInfoAuxDyn.isPassed == 1 &&  HGamEventInfoAuxDyn.yybb_btag77_vbf_selected== 0 && ((HGamEventInfoAuxDyn.yybb_nonRes_XGBoost_btag77_Cat % 10) == 3) )",
      "XGBoost_btag77_Nominal_looseScore_LMass" : "(HGamEventInfoAuxDyn.isPassed == 1 &&  HGamEventInfoAuxDyn.yybb_btag77_vbf_selected== 0 && ((HGamEventInfoAuxDyn.yybb_nonRes_XGBoost_btag77_Cat % 10) == 4) )",

      "XGBoost_btag77_Nominal_BCal_tightScore_HMass" : "(HGamEventInfoAuxDyn.isPassed == 1 &&  HGamEventInfoAuxDyn.yybb_btag77_BCal_vbf_selected == 0 && ((HGamEventInfoAuxDyn.yybb_nonRes_XGBoost_btag77_BCal_Cat % 10) == 1) )",
      "XGBoost_btag77_Nominal_BCal_looseScore_HMass" : "(HGamEventInfoAuxDyn.isPassed == 1 &&  HGamEventInfoAuxDyn.yybb_btag77_BCal_vbf_selected == 0 && ((HGamEventInfoAuxDyn.yybb_nonRes_XGBoost_btag77_BCal_Cat % 10) == 2) )",
      "XGBoost_btag77_Nominal_BCal_tightScore_LMass" : "(HGamEventInfoAuxDyn.isPassed == 1 &&  HGamEventInfoAuxDyn.yybb_btag77_BCal_vbf_selected == 0 && ((HGamEventInfoAuxDyn.yybb_nonRes_XGBoost_btag77_BCal_Cat % 10) == 3) )",
      "XGBoost_btag77_Nominal_BCal_looseScore_LMass" : "(HGamEventInfoAuxDyn.isPassed == 1 &&  HGamEventInfoAuxDyn.yybb_btag77_BCal_vbf_selected == 0 && ((HGamEventInfoAuxDyn.yybb_nonRes_XGBoost_btag77_BCal_Cat % 10) == 4) )",

     

      "VBF_btag77" : "(HGamEventInfoAuxDyn.isPassed == 1 && ((HGamEventInfoAuxDyn.yybb_nonRes_XGBoost_btag77_Cat % 10) != 9) && (HGamEventInfoAuxDyn.yybb_btag77_vbf_selected == 1) )",

      "VBF_btag77_BCal" : "(HGamEventInfoAuxDyn.isPassed == 1 &&  ((HGamEventInfoAuxDyn.yybb_nonRes_XGBoost_btag77_BCal_Cat % 10) != 9) && (HGamEventInfoAuxDyn.yybb_btag77_BCal_vbf_selected == 1) )",
