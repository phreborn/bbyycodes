  ...
  "sequencer":["VariablePlotter"],
   ...
   "dumper":{
    ...
    "selections": {
      ...
      "XGBoost_btag77_85_noMbb_BReg_tightScore_HMass" : "(HGamEventInfoAuxDyn.isPassed == 1 && (((HGamEventInfoAuxDyn.yybb_nonRes_XGBoost_btag77_85_BReg_Cat/100) % 10) == 1) )",
      "XGBoost_btag77_85_noMbb_BReg_looseScore_HMass" : "(HGamEventInfoAuxDyn.isPassed == 1 && (((HGamEventInfoAuxDyn.yybb_nonRes_XGBoost_btag77_85_BReg_Cat/100) % 10) == 2) )",
      "XGBoost_btag77_85_noMbb_BReg_tightScore_LMass" : "(HGamEventInfoAuxDyn.isPassed == 1 && (((HGamEventInfoAuxDyn.yybb_nonRes_XGBoost_btag77_85_BReg_Cat/100) % 10) == 3) )",
      "XGBoost_btag77_85_noMbb_BReg_looseScore_LMass" : "(HGamEventInfoAuxDyn.isPassed == 1 && (((HGamEventInfoAuxDyn.yybb_nonRes_XGBoost_btag77_85_BReg_Cat/100) % 10) == 4) )",

      "XGBoost_btag77_noMbb_BReg_tightScore_HMass"    : "(HGamEventInfoAuxDyn.isPassed == 1 && (((HGamEventInfoAuxDyn.yybb_nonRes_XGBoost_btag77_BReg_Cat/100) % 10) == 1)    )",
      "XGBoost_btag77_noMbb_BReg_looseScore_HMass"    : "(HGamEventInfoAuxDyn.isPassed == 1 && (((HGamEventInfoAuxDyn.yybb_nonRes_XGBoost_btag77_BReg_Cat/100) % 10) == 2)    )",
      "XGBoost_btag77_noMbb_BReg_tightScore_LMass"    : "(HGamEventInfoAuxDyn.isPassed == 1 && (((HGamEventInfoAuxDyn.yybb_nonRes_XGBoost_btag77_BReg_Cat/100) % 10) == 3)    )",
      "XGBoost_btag77_noMbb_BReg_looseScore_LMass"    : "(HGamEventInfoAuxDyn.isPassed == 1 && (((HGamEventInfoAuxDyn.yybb_nonRes_XGBoost_btag77_BReg_Cat/100) % 10) == 4)    )",
