{
  "sequencer":["VariablePlotter"],
    ...
    "selections": {
      ...
      "BDT_Selection_h025" : "(HGamEventInfoAuxDyn.isPassed && HGamEventInfoAuxDyn.N_j_central>=2 && HGamEventInfoAuxDyn.yybb_btag77_85_cutFlow==6 && 1/sqrt( pow(55,2)+pow(45,2) ) * sqrt( pow(55,2)*pow((HGamEventInfoAuxDyn.yybb_btag77_resonant_score_yy+1)/2,2) + pow(45,2)*pow((HGamEventInfoAuxDyn.yybb_btag77_resonant_score_ttH+1)/2,2) ) > 0.85 && HGamEventInfoAuxDyn.yybb_m_yyjj_tilde > ((298.248-2*6.80417)*1000) &&  HGamEventInfoAuxDyn.yybb_m_yyjj_tilde < ((298.248+2*6.80417)*1000))",

      "BDT_Selection_h025_h024_optimized" : "(HGamEventInfoAuxDyn.isPassed && HGamEventInfoAuxDyn.N_j_central>=2 && HGamEventInfoAuxDyn.yybb_btag77_85_cutFlow==6 && 1/sqrt( pow(50,2)+pow(50,2) ) * sqrt( pow(50,2)*pow((HGamEventInfoAuxDyn.yybb_btag77_resonant_score_yy+1)/2,2) + pow(50,2)*pow((HGamEventInfoAuxDyn.yybb_btag77_resonant_score_ttH+1)/2,2) ) > 0.85 && HGamEventInfoAuxDyn.yybb_m_yyjj_tilde > ((298.248-2*6.80417)*1000) &&  HGamEventInfoAuxDyn.yybb_m_yyjj_tilde < ((298.248+2*6.80417)*1000))"
