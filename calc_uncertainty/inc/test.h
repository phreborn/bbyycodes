...
// Sat Mar 31 15:41:33 2018 by ROOT version 6.04/16
// from TTree test/test
// found on file: bdt_0321/ttH_Z0_extract_had/hadronic_bdt_cat/ttH_hadronic_test.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("bdt_0321/ttH_Z0_extract_had/hadronic_bdt_cat/ttH_hadronic_test.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("bdt_0321/ttH_Z0_extract_had/hadronic_bdt_cat/ttH_hadronic_test.root");
      }
