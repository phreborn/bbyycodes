...
int main(int argc, char **argv){
  ...
  if(Opt["LIMIT"]){
	...
	ymax=10;
      ...
      if(option.Contains("hvt_wz")){
	fileName[0]="combined_VV_HVT_WZ_nominal_20160206";          legText[0]="\"Nominal\"";      scaleOpt[0]="hvt_wz";
	fileName[1]="combined_VV_HVT_WZ_jes_20160206";              legText[1]="\"JES\"";          scaleOpt[1]="hvt_wz";
	fileName[2]="combined_VV_HVT_WZ_largeR_20160206";           legText[2]="\"Large-R\"";      scaleOpt[2]="hvt_wz";
	fileName[3]="combined_VV_HVT_WZ_default_20160206";          legText[3]="Default";          scaleOpt[3]="hvt_wz";
	nsample=4;
      }
