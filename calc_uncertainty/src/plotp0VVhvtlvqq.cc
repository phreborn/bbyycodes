...
int main(int argc, char** argv) 
{
  ...
  pair<double, double> maxdata=readInput("pvalue/lvqq_HVT_WW_20160126_EOYE",data);
  ...
  leg->AddEntry(g_data,"EOYE results","L");
  leg->AddEntry(g_data2,"Updated results","L");
  ...
  system("mkdir -vp fig/plot_p0/lvqq_HVT_WW/");
  PrintCanvas(c1,"fig/plot_p0/lvqq_HVT_WW/pvalue");
