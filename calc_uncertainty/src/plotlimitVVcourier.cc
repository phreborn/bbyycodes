...
int main(int argc, char **argv){
  ...
  if(Opt["LIMIT"]){
	...
	fileName[0]="EOYE_llqq";          legText[0]="llqq";        scaleOpt[0]="";
	fileName[1]="EOYE_lvqq";          legText[1]="l#nuqq";      scaleOpt[1]="";
	fileName[2]="EOYE_vvqq";          legText[2]="#nu#nuqq";    scaleOpt[2]="";
	fileName[3]="EOYE_qqqq";	  legText[3]="qqqq";	    scaleOpt[3]="scalexs";
	nsample=4;
      }
      if(option.Contains("hvt_ww")){
	fileName[0]="lvqq_HVT_WW_20160126";          legText[0]="l#nuqq";          scaleOpt[0]="hvt_ww";
	fileName[1]="qqqq_HVT_WW_20160126";	     legText[1]="qqqq";            scaleOpt[1]="hvt_ww";
	fileName[2]="combined_VV_HVT_WW_20160126";   legText[2]="Combined";        scaleOpt[2]="hvt_ww";
	nsample=3;				     			       
      }						     			       
	...
	if(scaleOpt[jj].Contains("scalexs")){
	  int idx=-1;
	...
	likelihd_limit_c[jj]->SetLineWidth(2);
      ...
      likelihd_limit_d[jj]->SetLineColor(ColorWheel(nsample-jj));
      likelihd_limit_c[jj]->SetLineColor(ColorWheel(nsample-jj));
