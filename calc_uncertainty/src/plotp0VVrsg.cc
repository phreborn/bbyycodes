...
int main(int argc, char** argv) 
{
  ...
  pair<double, double> maxdata=readInput("pvalue/combined_VV_RSG_ZZ_20160126",data);
  double Z = maxdata.second;
  double M_minimum = maxdata.first;

  pair<double, double> maxdata2=readInput("pvalue/combined_VV_RSG_WW_20160126",data2);
  double Z2 = maxdata2.second;
  double M2_minimum = maxdata2.first;

  pair<double, double> maxdata3=readInput("pvalue/combined_VV_RSG_comb_20160126",data3);
  ...
  leg->AddEntry(g_data,"G*#rightarrowZZ","L");
  leg->AddEntry(g_data2,"G*#rightarrowWW","L");
  leg->AddEntry(g_data3,"G*#rightarrowWW/ZZ","L");
  ...
  system("mkdir -vp fig/plot_p0/combined_VV_RSG/");
  PrintCanvas(c1,"fig/plot_p0/combined_VV_RSG/pvalue");
