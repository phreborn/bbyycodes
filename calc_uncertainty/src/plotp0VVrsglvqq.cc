...
int main(int argc, char** argv) 
{
  ...
  pair<double, double> maxdata=readInput("pvalue/lvqq_RSG_WW_20160126_EOYE",data);
  ...
  system("mkdir -vp fig/plot_p0/lvqq_RSG_WW/");
  PrintCanvas(c1,"fig/plot_p0/lvqq_RSG_WW/pvalue");
