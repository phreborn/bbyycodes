...
int main(int argc, char** argv) 
{
  ...
  pair<double, double> maxdata=readInput("pvalue/qqqq_HVT_WW_20160126",data);
  double Z = maxdata.second;
  double M_minimum = maxdata.first;

  pair<double, double> maxdata2=readInput("pvalue/lvqq_HVT_WW_20160126",data2);
  double Z2 = maxdata2.second;
  double M2_minimum = maxdata2.first;

  pair<double, double> maxdata3=readInput("pvalue/combined_VV_HVT_WW_20160126",data3);
  ...
  system("mkdir -vp fig/plot_p0/combined_VV_HVT_WW/");
  PrintCanvas(c1,"fig/plot_p0/combined_VV_HVT_WW/pvalue");
