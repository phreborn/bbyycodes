...
int main(int argc, char** argv) 
{
  ...
  pair<double, double> maxdata=readInput("pvalue/high_mass_diphoton_13TeV_nwa/",data);
  ...
  leg->AddEntry(g_data,"13 TeV observed","L");
  leg->AddEntry(g_data2,"8 TeV observed","L");
