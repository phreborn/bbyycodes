...
int main( int argc, char** argv ){
  ...
  x1->setMax(2000);
  RooRealVar* x2 = w2->var("obs_x_channel");
  x2->setMax(2000);
  ...
  w1->pdf("pdf_background_inclusive_13TeV")->plotOn(frame1,LineColor(kBlue));
  ...
  w2->pdf("pdf_background_inclusive_13TeV")->plotOn(frame2,LineColor(kRed),Normalization(w2->data("combData")->sumEntries()));
  ...
  TPad *pad1 =  new TPad("pad1","pad1name",0.01,0.30,0.99,0.99);
  TPad *pad2 =  new TPad("pad2","pad2name",0.01,0.00,0.99,0.30);
  ...
  c1->Print("bkgComp.eps");
  c1->Print("bkgComp.pdf");
