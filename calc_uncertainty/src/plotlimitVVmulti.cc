...
double mass_RSG_XS[25]={500,600,700,800,900,
			1000,1100,1200,1300,1400,
			1500,1600,1700,1800,1900,
			2000,2200,2400,2600,2800,
			3000,3500,4000,4500,5000};
double RSG_XS_WW[25]={4.63,1.565,0.6438,0.3011,0.1544,
		      0.08461,0.04883,0.02936,0.01827,0.01169,
		      0.007655,0.005113,0.003474,0.002397,0.001676,
		      0.001185,0.0006115,0.0003263,0.0001788,0.0001,
		      5.703e-05,1.486e-05,4.114e-06,1.189e-06,3.579e-07};
double RSG_XS_ZZ[25]={2.474,0.822,0.3339,0.155,0.07899,
		      0.0431,0.02481,0.01488,0.009243,0.005904,
		      0.003863,0.002577,0.001749,0.001206,0.0008427,
		      0.0005957,0.0003071,0.0001638,8.966e-05,5.016e-05,
		      2.859e-05,7.447e-06,2.06e-06,5.955e-07,1.793e-07};
...
int main(int argc, char **argv){
  ...
  if(Opt["LIMIT"]){
	...
	ymax=20;
      ...
      if(option.Contains("hvt_wz")){
	fileName[0]="llqq_HVT_WZ_20160522";          legText[0]="llqq";        scaleOpt[0]="hvt_wz";  color[0]=CommonFunc::ColorWheel(4)+1;
	fileName[1]="lvqq_HVT_WZ_20160522";          legText[1]="l#nuqq";      scaleOpt[1]="hvt_wz";  color[1]=CommonFunc::ColorWheel(3)+1;
	fileName[2]="vvqq_HVT_WZ_20160522";          legText[2]="#nu#nuqq";    scaleOpt[2]="hvt_wz";  color[2]=CommonFunc::ColorWheel(2);
	fileName[3]="qqqq_HVT_WZ_20160522";	     legText[3]="qqqq";	       scaleOpt[3]="hvt_wz";  color[3]=CommonFunc::ColorWheel(1);
	fileName[4]="combined_VV_HVT_WZ_20160522";   legText[4]="Combined";    scaleOpt[4]="hvt_wz";  color[4]=CommonFunc::ColorWheel(0);  
	nsample=5;
      }
      if(option.Contains("hvt_ww")){
	fileName[0]="lvqq_HVT_WW_20160522";          legText[0]="l#nuqq";          scaleOpt[0]="hvt_ww";  color[0]=CommonFunc::ColorWheel(3)+1;
	fileName[1]="qqqq_HVT_WW_20160522";	     legText[1]="qqqq";            scaleOpt[1]="hvt_ww";  color[1]=CommonFunc::ColorWheel(1);
	fileName[2]="combined_VV_HVT_WW_20160522";   legText[2]="Combined";        scaleOpt[2]="hvt_ww";  color[2]=CommonFunc::ColorWheel(0);
	nsample=3;				     			       				
      }						     			       				
      if(option.Contains("hvt_comb")){
	fileName[0]="llqq_HVT_WZ_20160522";          legText[0]="llqq";          scaleOpt[0]="hvt_comb";  color[0]=CommonFunc::ColorWheel(4)+1;
	fileName[1]="lvqq_HVT_comb_20160522";	     legText[1]="l#nuqq";        scaleOpt[1]="hvt_comb";  color[1]=CommonFunc::ColorWheel(3)+1;
	fileName[2]="vvqq_HVT_WZ_20160522";	     legText[2]="#nu#nuqq";      scaleOpt[2]="hvt_comb";  color[2]=CommonFunc::ColorWheel(2);  
	fileName[3]="qqqq_HVT_comb_20160522";	     legText[3]="qqqq";          scaleOpt[3]="hvt_comb";  color[3]=CommonFunc::ColorWheel(1);  
	fileName[4]="combined_VV_HVT_comb_20160522"; legText[4]="Combined";      scaleOpt[4]="hvt_comb";  color[4]=CommonFunc::ColorWheel(0);  
	nsample=5;
      }
    }
	...
	fileName[0]="llqq_RSG_ZZ_20160522";            legText[0]="llqq";          scaleOpt[0]="rsg_zz";  color[0]=CommonFunc::ColorWheel(4)+1;
	fileName[1]="vvqq_RSG_ZZ_20160522";	       legText[1]="#nu#nuqq";      scaleOpt[1]="rsg_zz";  color[1]=CommonFunc::ColorWheel(2);
	fileName[2]="qqqq_RSG_ZZ_20160522";	       legText[2]="qqqq";          scaleOpt[2]="rsg_zz";  color[2]=CommonFunc::ColorWheel(1);  
	fileName[3]="combined_VV_RSG_ZZ_20160522";     legText[3]="Combined";      scaleOpt[3]="rsg_zz";  color[3]=CommonFunc::ColorWheel(0);    
	nsample=4;				       			       				
      }
      if(option.Contains("rsg_ww")){
	fileName[0]="lvqq_RSG_WW_20160522";            legText[0]="l#nuqq";        scaleOpt[0]="rsg_ww";  color[0]=CommonFunc::ColorWheel(3)+1;
	fileName[1]="qqqq_RSG_WW_20160522";	       legText[1]="qqqq";          scaleOpt[1]="rsg_ww";  color[1]=CommonFunc::ColorWheel(1);
	fileName[2]="combined_VV_RSG_WW_20160522";     legText[2]="Combined";      scaleOpt[2]="rsg_ww";  color[2]=CommonFunc::ColorWheel(0);
	nsample=3;				       			       
      }						       			       
      if(option.Contains("rsg_comb")){
	fileName[0]="llqq_RSG_ZZ_20160522";            legText[0]="llqq";              scaleOpt[0]="rsg_comb";  color[0]=CommonFunc::ColorWheel(4)+1;
	fileName[1]="lvqq_RSG_WW_20160522";	       legText[1]="l#nuqq";  	       scaleOpt[1]="rsg_comb";  color[1]=CommonFunc::ColorWheel(3)+1;
	fileName[2]="vvqq_RSG_ZZ_20160522";	       legText[2]="#nu#nuqq";	       scaleOpt[2]="rsg_comb";  color[2]=CommonFunc::ColorWheel(2);  
	fileName[3]="qqqq_RSG_comb_20160522";	       legText[3]="qqqq";    	       scaleOpt[3]="rsg_comb";  color[3]=CommonFunc::ColorWheel(1);  
	fileName[4]="combined_VV_RSG_comb_20160522";   legText[4]="Combined";	       scaleOpt[4]="rsg_comb";  color[4]=CommonFunc::ColorWheel(0);  
	nsample=5;
      }
    }
	...
	likelihd_limit_c[jj]->SetMarkerSize(0.9);
	...
	likelihd_limit_d[jj]->SetMarkerSize(0.6);
	likelihd_limit_c[jj]->SetMarkerSize(0.6);
      }
      likelihd_limit_d[jj]->SetLineStyle(1); 
      likelihd_limit_d[jj]->SetLineColor(color[jj]);
      likelihd_limit_c[jj]->SetLineColor(color[jj]);
      likelihd_limit_d[jj]->SetMarkerColor(color[jj]);
      likelihd_limit_c[jj]->SetMarkerColor(color[jj]);
      ...
      if(jj<nsample-1){
	leg->AddEntry(likelihd_limit_d[jj],legText[jj]+" obs.","lp");
	leg->AddEntry(likelihd_limit_c[jj],legText[jj]+" exp.","l");
      }
      else{
	leg2->AddEntry(likelihd_limit_d[jj],legText[jj]+" observed","lp");
  ...
  if(Opt["TWO"]){
    ...
    legText[0]="New"; legText[1]="Old";
    color[0]=kRed; color[1]=kBlue;
    TString type;
    ...
    if(option.Contains("logy")) cv->SetLogy();
    cv->RedrawAxis();
    TString outputCanvasName=Form("fig/limit_plot/%s/%s", jobname.Data(),jobname.Data());
    if(option.Contains("scalexs")) outputCanvasName+="_scalexs";
    PrintCanvas(cv, outputCanvasName);
    fout.close();
  }// 
